...
flowchart LR
    ...
    style B fill:#00b4d8,stroke:#0d1117,color:#000
    style C fill:#0096c7,stroke:#0d1117,color:#fff
    style D fill:#0077b6,stroke:#0d1117,color:#fff
    style E fill:#023e8a,stroke:#0d1117,color:#fff
    style F fill:#03045e,stroke:#0d1117,color:#fff
```
